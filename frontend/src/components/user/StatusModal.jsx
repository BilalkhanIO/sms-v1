...
import { useUpdateUserStatusMutation } from "../../api/usersApi";

const StatusModal = ({ isOpen, onClose, userId, initialStatus }) => {
    const [newStatus, setNewStatus] = React.useState(initialStatus);
