...
import { getDashboardStats, getSchoolAdmins, assignSchoolAdmin, removeSchoolAdmin, inviteSchoolAdmin } from '../controllers/multiSchoolAdminController.js';

const router = express.Router();

router.post('/invite', protect, authorize('MULTI_SCHOOL_ADMIN'), inviteSchoolAdmin);
